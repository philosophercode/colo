...
function handleOrientation(event) {
    ...
    // NO COLOR on Desktop
    if (event.alpha == null) {
        document.body.setAttribute("style", "background-image: url('./RGBblock.png');background-repeat: repeat;background-size: 100px 100px");
        
        const messageDesktop = document.querySelector('#messageDesktop');

        messageDesktop.innerHTML = 'Your web browser does not have access to a gyro! <br><br> Try the URL on your smartphone<br><br>';
        
        const qrCode = document.createElement('img');
        qrCode.setAttribute('src','qrCode.jpg');
        qrCode.setAttribute('width','200')
        qrCode.setAttribute('height','200')
        messageDesktop.appendChild(qrCode);
        return;
    }
    ...
    console.log(hue);
    console.log(hex);
    message.innerHTML = hue + '<br>' + colorName;
...
var ntc = {
    ...
    name: function(color) {
        ...
        return (cl < 0 ? ["#000000", "Invalid Color: " + color, false] : ["Estimated #" + ntc.names[cl][0] + '<br>Color: ' + ntc.names[cl][1]]);
    },
